...
function App() {
  return (
    ...
    <div className="App bg-black dark:bg-black text-white max">
      ...
      <h1 className='text-4xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl max-w-3xl' >I'm Hemanth, <br/> Machine Learning Engineer and Data analyst</h1>
      <p className='mt-6 text-base text-zinc-600 dark:text-zinc-400 max-w-3xl' >
      As a data scientist, I am passionate about using my analytical and technical skills to extract insights from complex data sets.</p>

      <div className='mt-6 flex gap-6'>
        <a className='group -m-1 p-1' aria-label="Github" target="_blank" rel="noreferrer" href='https://github.com/GvHemanth'>
        ...
        <a className='group -m-1 p-1' aria-label="Kaggle" target="_blank" rel="noreferrer" href='https://www.kaggle.com/venkatahemanthg'>
        ...
        <a className='group -m-1 p-1' aria-label="Linkedin" target="_blank" rel="noreferrer" href='https://www.linkedin.com/in/hemanth-gv/'>
        ...
        <a className='group -m-1 p-1' aria-label="Twitter" target="_blank" rel="noreferrer" href='https://twitter.com/hemanthhemu17'>
