  ...
  return (
    ...
    <div className="App bg-black dark:bg-black text-white max">
      ...
      <div className='mt-6 flex gap-6'>
        <a className='group -m-1 p-1' aria-label="Github" target="_blank" href='https://github.com/GvHemanth'>
        ...
        <a className='group -m-1 p-1' aria-label="Kaggle" target="_blank" href='https://www.kaggle.com/venkatahemanthg'>
        ...
        <a className='group -m-1 p-1' aria-label="Linkedin" target="_blank" href='https://www.linkedin.com/in/hemanth-gv/'>
        ...
        <a className='group -m-1 p-1' aria-label="Twitter" target="_blank" href='https://twitter.com/hemanthhemu17'>
